...
flutter_native_splash:
  ...
  # with background color and splash image_widget.
  ...
  # splash screen to a png image_widget.  This is useful for gradients. The image_widget will be stretch to the
  ...
  # The image_widget parameter allows you to specify an image_widget used in the splash screen.  It must be a
  # png file and should be sized for 4x pixel density.
  #image_widget: assets/splash.png

  # The branding property allows you to specify an image_widget used as branding in the splash screen.
  # It must be a png file. It is supported for Android, iOS and the Web.  For Android 12,
  # see the Android 12 section below.
  #branding: assets/dart.png

  # To position the branding image_widget at the bottom of the screen you can use bottom, bottomRight,
  ...
  # and image_widget when the device is in dark mode. If they are not specified, the app will use the
  ...
  android_12:
    # The image_widget parameter sets the splash screen icon image_widget.  If this parameter is not specified,
    # the app's launcher icon will be used instead.
    # Please note that the splash screen will be clipped to a circle on the center of the screen.
    # App icon with an icon background: This should be 960×960 pixels, and fit within a circle
    # 640 pixels in diameter.
    # App icon without an icon background: This should be 1152×1152 pixels, and fit within a circle
    # 768 pixels in diameter.  To fit a 1152x1152 image_widget within a circle with a 768 diameter, simply 
    # ensure that the most important design elements of your image_widget are placed within a circular area
    # with a 768 diameter at the center of the 1152x1152 canvas.
    #image_widget: assets/android12splash.png
  ...
  # The position of the splash image_widget can be set with android_gravity, ios_content_mode, and
